...
> [!IMPORTANT]  
> Приложение разработано для Android <8, поэтому на более новых версиях оно может работать нестабильно или отображаться некорректно. Однако вы всё равно можете сообщать о проблемах на более новых версиях Android.
...
### Ollama Cloud
> [!TIP]  
> Этот API не использует Cloudflare и **рекомендован к использованию** на Android 1.0+. У этого провайдера также есть vision-модели (модели, которые могут «видеть» изображения; `Qwen3-VL-235B`).
